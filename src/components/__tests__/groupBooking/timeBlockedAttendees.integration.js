...
describe('Group Booking Modal - Integration - Time Blocked Attendees', () => {
  it('should disable attendees who are booked on overlapping sessions', async () => {
    await initModal(conflictTestData, { buttonSelector: 'BUY $923' })
